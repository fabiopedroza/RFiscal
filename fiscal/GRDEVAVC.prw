...
// -- Nota Fiscal já existe na base
		SA1->(dbSetOrder(3), dbseek(xFilial("SA1")+cCnpjDest))
...
*/
		...
		aadd(aCabec,{"F1_FORNECE",_xCliente,Nil,Nil})
		aadd(aCabec,{"F1_LOJA"   ,_xLOJA,Nil,Nil})
		aadd(aCabec,{"F1_ESPECIE","SPED",Nil,Nil})
		aAdd(aCabec,{"F1_STATUS", "A" ,NIL, NIL})
		aAdd(aCabec,{"F1_MENNOTA", oNFe:_NfeProc:_PROTNFE:_INFPROT:_CHNFE:TEXT ,NIL, NIL})
		aadd(aCabec,{"F1_COND" ,"999" ,NIL, NIL})
		aadd(aCabec,{"F1_EST" ,oDestino:_enderdest:_UF:TEXT   ,NIL, NIL})
	...
	//{"F1_CHVNFE"	,oProt:_INFPROT:_CHNFE:TEXT			,NIL}}

	/*
		{"F1_DOC"		,Strzero(val(oIde:_nNF:TEXT), 9,0)	,NIL},;
	{"F1_SERIE"		,oIde:_serie:TEXT					,NIL},;
*/
...
*/
		...
		aadd(aLinha,{"D1_COD"	,"27.3.0020",Nil,Nil})
		aadd(aLinha,{"D1_UM" ,"UN" ,NIL})
		aadd(aLinha,{"D1_LOCAL" ,"01" ,NIL})

		aadd(aLinha,{"D1_NFORI"	,strzero(val(OIdent:_nNF:TEXT),6),Nil,Nil})
		aadd(aLinha,{"D1_SERIORI",OIdent:_serie:TEXT,Nil,Nil})
		aadd(aLinha,{"D1_ITEMORI","01",Nil,Nil})
		aadd(aLinha,{"D1_TES","005",Nil,Nil})
...
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
	...
	//	MSExecAuto({|x,y,z| MATA103(x,y,z)},aCabec,aItens,3)  // //3-Inclusão / 4-Classificação / 5-Exclusão
...
//Pegando o model dos campos da SA2
	...
	oSA2Mod:setValue("A2_NATUREZ",     	"201091"   													) // Natureza
